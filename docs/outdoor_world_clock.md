...
The 20-minute cycle is day 0–6, dusk 6–8, night 8–16, dawn 16–18, and morning-to-noon 18–20 minutes. Development-only `timeOfDay` and `dayCycleSpeed` query overrides never write canonical state.
