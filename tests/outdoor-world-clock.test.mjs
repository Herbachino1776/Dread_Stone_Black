...
import { OutdoorWorldClock, OUTDOOR_CYCLE_DURATION_MS, OUTDOOR_CLOCK_STORAGE_KEY, resolveOutdoorSkyWeights } from '../src/game/world-scene/OutdoorWorldClock.js';
...
console.log('Outdoor world clock: 11 focused contracts PASS');
