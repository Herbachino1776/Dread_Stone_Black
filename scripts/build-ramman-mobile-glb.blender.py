...
SRC_DIR = REPO / "public" / "assets" / "npcs" / "ram_man"
OUT = SRC_DIR.parent / "ram_man_folsom_mobile.glb"

SOURCES = {
    "idle": SRC_DIR / "ram_man_friendly_idle_01.glb",
    "walk": SRC_DIR / "ram_man_friendly_walk_01.glb",
    # Add a real authored death GLB here when available; do not export a canonical
    # herd bundle that fakes death by duplicating idle.
    # "die": SRC_DIR / "ram_man_friendly_die_01.glb",
}
...
def main():
    ...
    print("  one RamMan mesh")
    print("  one armature")
    print("  clips/actions from SOURCES (currently idle, walk; add die when an authored death GLB exists)")
