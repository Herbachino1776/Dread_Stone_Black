...
['SPAWNING', 'BLENDING_TO_WALK', 'APPROACHING', 'BLENDING_TO_IDLE', 'NEAR_PLAYER', 'HIT_REACTING', 'LOSING_CONSCIOUSNESS', 'SETTLING_TO_GROUND', 'GROUNDED', 'DISPOSED', 'RESPAWNING'].forEach((state) => assert.match(walkerSource, new RegExp(state)));
...
assert.match(walkerSource, /groundCollapseSeconds: 2\.35/);
