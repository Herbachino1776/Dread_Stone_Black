...
export function createOutdoorSplineTrailMesh(trail, { terrainSampler, textures = {}, makeMaterial, yOffset = OARB_SPLINE_TRAIL_Y_OFFSET } = {}) {
  ...
  mesh.userData = {
    ...
    collisionNote: safe.pathSupport
      ? 'No collision is generated by the visual dirt ribbon; an optional legacy spline path support may be attached by DungeonScene.'
      : 'No collision is generated by the visual dirt ribbon; this trail intentionally uses terrain/polygon floors for player grounding instead of hidden path support slabs.',
  };
  return mesh;
}
