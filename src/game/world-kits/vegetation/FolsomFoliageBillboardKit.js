...
const FOLSOM_FOLIAGE_SIZE_BANDS = Object.freeze({
  redwood: Object.freeze([
    ['young', { height: 7.6, widthScale: 0.47, weight: 1.1, scaleJitter: 0.11, sinkIntoGround: 0.1 }],
    ['tall', { height: 10.2, widthScale: 0.5, weight: 1.35, scaleJitter: 0.1, sinkIntoGround: 0.12 }],
    ['giant', { height: 13.4, widthScale: 0.52, weight: 0.95, scaleJitter: 0.09, sinkIntoGround: 0.14 }],
    ['ancient', { height: 16.2, widthScale: 0.54, weight: 0.42, scaleJitter: 0.08, sinkIntoGround: 0.16 }],
  ]),
  cedar: Object.freeze([
    ['small', { height: 5.2, widthScale: 0.58, weight: 1.2, scaleJitter: 0.13, sinkIntoGround: 0.08 }],
    ['medium', { height: 6.8, widthScale: 0.6, weight: 1.4, scaleJitter: 0.12, sinkIntoGround: 0.09 }],
    ['tall', { height: 8.6, widthScale: 0.62, weight: 0.75, scaleJitter: 0.1, sinkIntoGround: 0.1 }],
  ]),
  understory: Object.freeze([
    ['rush', { height: 1.45, widthScale: 0.95, weight: 1.35, scaleJitter: 0.18, sinkIntoGround: 0.03 }],
    ['brush', { height: 2.05, widthScale: 1.08, weight: 1.2, scaleJitter: 0.16, sinkIntoGround: 0.04 }],
    ['shrub', { height: 2.85, widthScale: 0.82, weight: 0.55, scaleJitter: 0.15, sinkIntoGround: 0.05 }],
  ]),
});
...
function createLayerVariants(layer, spritePaths, sizeBands = FOLSOM_FOLIAGE_SIZE_BANDS[layer]) {
  return spritePaths.flatMap((path, spriteIndex) => {
    ...
    return sizeBands.map(([band, metrics]) => Object.freeze({
      ...
      bottomTransparentPaddingRatio: 0,
      sinkIntoGround: metrics.sinkIntoGround,
