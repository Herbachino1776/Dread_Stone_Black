...
export const LURE_DANGLE_DISTANCE_FROM_TIP = 0.18;
export const LURE_DANGLE_BACKSET_FROM_TIP = 0.035;
export const LURE_DANGLE_SWAY = 0.028;
export const LURE_DANGLE_SPRING = 42;
export const LURE_DANGLE_DAMPING = 8.5;
