...
export const LINE_SPOOL_OUT_SPEED = 30;
export const LINE_MAX_SPOOL_OUT_PER_FRAME = 0.96;
export const LINE_CAST_PAYOUT_GRACE_SECONDS = 0.28;
export const LINE_CAST_PAYOUT_BUFFER = 0.42;
export const LINE_CAST_PAYOUT_GRACE_SPEED_MULTIPLIER = 3.2;
export const LINE_CAST_PAYOUT_GRACE_MAX_PER_FRAME = 2.6;
export const LINE_CAST_PAYOUT_GRACE_TENSION_SCALE = 0.12;
export const LINE_AUTO_REEL_SPEED = 1.05;
export const LINE_REEL_PULL_BOOST = 0.7;
export const LINE_MANUAL_REEL_PULL_ACCEL = 7.8;
