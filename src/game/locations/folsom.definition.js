...
export const folsomDefinition = Object.freeze({
  ...
  lights: [
    { id: 'folsom_ambient', kind: 'ambient', skyColor: 0x605650, groundColor: 0x26211d, intensity: 0.46 },
    { id: 'folsom_morning_sun', kind: 'directional', color: 0x8f7868, intensity: 0.56, position: { x: 90, y: 70, z: -65 }, target: { x: 0, y: 0, z: 5 }, castShadow: true },
    { id: 'folsom_courtyard_fire_fill', kind: 'point', color: 0xffa14f, intensity: 0.55, distance: 18, decay: 1.6, position: { x: -8, y: 2.4, z: -14 } },
