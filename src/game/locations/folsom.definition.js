...
export const folsomDefinition = Object.freeze({
  ...
  spawns: [
    ...
    { id: 'folsom_neckman_feud_01', kind: 'enemy', species: 'neck_man', faction: 'neck_man', preferredFaction: 'neck_man', position: { x: 8, y: 0.16, z: 20 }, yaw: -0.15, roomId: 'folsom_bounds', allowedForInitialWave: true, allowedForRespawn: true, minDistanceFromPlayer: 24, scale: 1.7, tags: ['folsom-blood-feud', 'initial-wave'], userData: { bloodFeud: true, freeForAllFaction: true, scaleMultiplier: 1.7 } },
    { id: 'folsom_neckman_feud_02', kind: 'enemy', species: 'neck_man', faction: 'neck_man', preferredFaction: 'neck_man', position: { x: 17, y: 0.16, z: 25 }, yaw: -2.35, roomId: 'folsom_bounds', allowedForInitialWave: true, allowedForRespawn: true, minDistanceFromPlayer: 28, scale: 1.7, tags: ['folsom-blood-feud', 'initial-wave'], userData: { bloodFeud: true, freeForAllFaction: true, scaleMultiplier: 1.7 } },
    { id: 'folsom_neckman_feud_03', kind: 'enemy', species: 'neck_man', faction: 'neck_man', preferredFaction: 'neck_man', position: { x: 4, y: 0.16, z: 31 }, yaw: 1.95, roomId: 'folsom_bounds', allowedForInitialWave: true, allowedForRespawn: true, minDistanceFromPlayer: 28, scale: 1.7, tags: ['folsom-blood-feud', 'initial-wave'], userData: { bloodFeud: true, freeForAllFaction: true, scaleMultiplier: 1.7 } },
  ],
  exits: [{
