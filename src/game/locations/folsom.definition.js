...
const textures = Object.freeze({
  ...
  folsomGrass: { ...outdoorTextureProfiles.grassMatted, repeat: [42, 42], color: 0x929a74, emissive: 0x1b2115, emissiveIntensity: 0.1 },
  townPath: { ...outdoorTextureProfiles.mudPebblyEarth, repeat: [20, 4], color: 0x806a4c, emissive: 0x1c1309, emissiveIntensity: 0.07, worldTileLength: 8, worldTileWidth: 3 },
  courtyardStone: { path: './assets/textures/floor_worn_stone_01.png', repeat: [5, 5], color: 0x969083, roughness: 0.97, metalness: 0, emissive: 0x15120e, emissiveIntensity: 0.1 },
  ...
  darkStone: { path: './assets/textures/wall_black_stone_01.png', repeat: [2.2, 1.6], color: 0x605e57, roughness: 0.99, metalness: 0, emissive: 0x11100c, emissiveIntensity: 0.1 },
  agedWood: { path: './assets/textures/pack1/wood_dark_aged_01.png', repeat: [2.2, 1.5], color: 0x78593c, roughness: 0.96, metalness: 0, emissive: 0x160d08, emissiveIntensity: 0.09 },
...
export const folsomDefinition = Object.freeze({
  ...
  fog: { color: 0x332820, near: 92, far: 270 },
  ...
  lights: [
    { id: 'folsom_ambient', kind: 'ambient', skyColor: 0x746a61, groundColor: 0x342d27, intensity: 0.58 },
    { id: 'folsom_morning_sun', kind: 'directional', color: 0xa18f7b, intensity: 0.68, position: { x: 90, y: 70, z: -65 }, target: { x: 0, y: 0, z: 5 }, castShadow: true },
    { id: 'folsom_courtyard_fire_fill', kind: 'point', color: 0xffa14f, intensity: 0.62, distance: 19, decay: 1.6, position: { x: -8, y: 2.4, z: -14 } },
    { id: 'folsom_shrine_fill', kind: 'point', color: 0x806050, intensity: 0.28, distance: 16, decay: 1.65, position: { x: -42, y: 2.8, z: 39 } },
  ],
