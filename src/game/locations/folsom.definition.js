...
export const folsomDefinition = Object.freeze({
  ...
  spawns: [
    ...
    { id: 'folsom_neckman_feud_01', kind: 'enemy', species: 'neck_man', faction: 'neck_man', preferredFaction: 'neck_man', position: { x: 64, y: 0.24, z: 27 }, yaw: -2.45, roomId: 'folsom_bounds', allowedForInitialWave: true, allowedForRespawn: true, minDistanceFromPlayer: 62, scale: 1.45, tags: ['folsom-blood-feud', 'initial-wave'], userData: { bloodFeud: true, freeForAllFaction: true, scaleMultiplier: 1.45 } },
    { id: 'folsom_neckman_feud_02', kind: 'enemy', species: 'neck_man', faction: 'neck_man', preferredFaction: 'neck_man', position: { x: 72, y: 0.31, z: 34 }, yaw: -2.95, roomId: 'folsom_bounds', allowedForInitialWave: true, allowedForRespawn: true, minDistanceFromPlayer: 72, scale: 1.45, tags: ['folsom-blood-feud', 'initial-wave'], userData: { bloodFeud: true, freeForAllFaction: true, scaleMultiplier: 1.45 } },
    { id: 'folsom_neckman_feud_03', kind: 'enemy', species: 'neck_man', faction: 'neck_man', preferredFaction: 'neck_man', position: { x: 61, y: 0.21, z: 39 }, yaw: -1.95, roomId: 'folsom_bounds', allowedForInitialWave: true, allowedForRespawn: true, minDistanceFromPlayer: 72, scale: 1.45, tags: ['folsom-blood-feud', 'initial-wave'], userData: { bloodFeud: true, freeForAllFaction: true, scaleMultiplier: 1.45 } },
  ],
  exits: [{
