...
export const folsomDefinition = Object.freeze({
  ...
  fog: { color: 0x3a1713, near: 38, far: 178 },
  lighting: { background: 0x120807 },
  skyDome: {
    ...
    widthSegments: 48,
    heightSegments: 24,
    rotation: { x: -0.06, y: Math.PI * 0.92, z: 0 },
    position: { x: 0, y: -8, z: 0 },
    horizonAlignment: 'Sphere is lowered and tipped slightly downward so the panorama black horizon stays low behind Folsom walls, terrain, trees, fog, and pond silhouettes instead of rising into a wall.',
  },
  textures,
  defaultFloorY: 0,
  ...
  lights: [
    { id: 'folsom_ambient', kind: 'ambient', skyColor: 0x5b2824, groundColor: 0x211712, intensity: 0.78 },
    { id: 'folsom_morning_sun', kind: 'directional', color: 0x9f3a2f, intensity: 0.88, position: { x: 90, y: 70, z: -65 }, target: { x: 0, y: 0, z: 5 }, castShadow: true },
    { id: 'folsom_courtyard_fire_fill', kind: 'point', color: 0xffa14f, intensity: 0.75, distance: 22, decay: 1.5, position: { x: -8, y: 2.4, z: -14 } },
    { id: 'folsom_shrine_fill', kind: 'point', color: 0xa86b48, intensity: 0.46, distance: 18, decay: 1.55, position: { x: -42, y: 2.8, z: 39 } },
  ],
