...
const folsomTerrain = Object.freeze({
  ...
  heightStamps: [
      ...
      terrainStampKit.buildingPad({ id: 'folsom_shrine_side_room_pad', center: [-59, 39], radius: 10.5, y: 0.76, tags: ['shrine-side-room', 'under-shrine-maintenance'] }),
      terrainStampKit.buildingPad({ id: 'folsom_shrine_crawlspace_pad', center: [-66, 39], radius: 6.5, y: 0.76, tags: ['shrine-crawlspace', 'under-shrine-maintenance'] }),
...
const folsomFoliageAvoidZones = Object.freeze([
  ...
  { center: [-42, 38], radius: 13 }, { center: [-42, 31], radius: 9 }, { center: [-61, 39], radius: 14 }, { center: [42, 42], radius: 14 },
...
export const FOLSOM_CONNECTED_GROWTH_NETWORK = Object.freeze({
  ...
  revealStateKey: 'folsom_under_shrine_network_revealed',
  underShrineOrigin: Object.freeze([-66.8, 39]),
  tags: Object.freeze(['connected-growth-root', 'chapter-2', 'under-shrine-network', 'static-world-authoring']),
  lock: Object.freeze({
...
export const folsomDefinition = Object.freeze({
  ...
  polygonFloors: [
    ...
    rectFloor('folsom_shrine_side_room_floor', -61, -52, 34, 44, 'shrineStone', 'folsom_bounds', ['shrine-side-room', 'keeper-maintenance-space', 'terrain-pad-aligned'], 0.788),
    rectFloor('folsom_shrine_crawlspace_floor', -69, -61, 37.35, 40.65, 'darkStone', 'folsom_bounds', ['shrine-crawlspace', 'under-shrine-maintenance', 'terrain-pad-aligned'], 0.788),
  ...
  wallSegments: [
    ...
    { id: 'folsom_shrine_side_room_north', from: [-61, 44], to: [-52, 44], y: 0.76, height: 2.85, thickness: 0.42, material: 'darkStone', roomId: 'folsom_bounds', tags: ['shrine-side-room', 'keeper-maintenance-space'] },
    { id: 'folsom_shrine_side_room_south', from: [-61, 34], to: [-52, 34], y: 0.76, height: 2.85, thickness: 0.42, material: 'darkStone', roomId: 'folsom_bounds', tags: ['shrine-side-room', 'keeper-maintenance-space'] },
    { id: 'folsom_shrine_side_room_west_north', from: [-61, 40.65], to: [-61, 44], y: 0.76, height: 2.85, thickness: 0.42, material: 'darkStone', roomId: 'folsom_bounds', tags: ['shrine-side-room', 'crawlspace-opening'] },
    { id: 'folsom_shrine_side_room_west_south', from: [-61, 34], to: [-61, 37.35], y: 0.76, height: 2.85, thickness: 0.42, material: 'darkStone', roomId: 'folsom_bounds', tags: ['shrine-side-room', 'crawlspace-opening'] },
    { id: 'folsom_shrine_crawlspace_north', from: [-69, 40.65], to: [-61, 40.65], y: 0.76, height: 1.55, thickness: 0.38, material: 'darkStone', roomId: 'folsom_bounds', tags: ['shrine-crawlspace', 'low-maintenance-passage'] },
    { id: 'folsom_shrine_crawlspace_south', from: [-69, 37.35], to: [-61, 37.35], y: 0.76, height: 1.55, thickness: 0.38, material: 'darkStone', roomId: 'folsom_bounds', tags: ['shrine-crawlspace', 'low-maintenance-passage'] },
  ...
  horizontalSurfaces: [
    ...
    { id: 'folsom_shrine_side_room_roof', kind: 'ceiling', shape: 'rect', center: [-56.5, 3.66, 39], width: 9, depth: 10, y: 3.66, thickness: 0.24, material: 'darkStone', roomId: 'folsom_bounds', walkable: false, tags: ['shrine-side-room', 'buried-slab-roof'] },
    { id: 'folsom_shrine_crawlspace_ceiling', kind: 'ceiling', shape: 'rect', center: [-65, 2.38, 39], width: 8, depth: 3.3, y: 2.38, thickness: 0.22, material: 'darkStone', roomId: 'folsom_bounds', walkable: false, tags: ['shrine-crawlspace', 'low-ceiling'] },
  ],
  architecturalPrimitives: [
    ...
    { id: 'folsom_shrine_side_room_door', kind: 'stela', position: [-52.08, 0.788, 38.32], yaw: Math.PI / 2, width: 2.38, height: 2.18, thickness: 0.24, material: 'agedWood', blocksPlayer: true, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'side-door', 'growth-sealed'] },
    { id: 'folsom_shrine_side_room_door_frame', kind: 'doorFrame', position: [-52.04, 0.788, 38.32], yaw: Math.PI / 2, width: 2.82, height: 2.65, thickness: 0.38, depth: 0.46, material: 'darkStone', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'side-door-frame'] },
    { id: 'folsom_shrine_keeper_workbench', kind: 'altar', position: [-57.4, 0.788, 35.15], width: 3.2, depth: 0.9, height: 0.82, material: 'agedWood', blocksPlayer: true, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'keeper-workbench', 'lantern-pickup-setting'] },
    { id: 'folsom_shrine_keeper_low_shelf', kind: 'altar', position: [-59.75, 0.788, 42.75], width: 1.6, depth: 0.62, height: 0.56, material: 'agedWood', blocksPlayer: true, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'maintenance-shelf'] },
    { id: 'folsom_shrine_keeper_broken_work_surface', kind: 'altar', position: [-53.35, 0.788, 42.55], width: 2.1, depth: 0.74, height: 0.68, material: 'agedWood', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'broken-keeper-work-surface', 'non-blocking-dressing'] },
    { id: 'folsom_shrine_keeper_wall_shelf_low', kind: 'stela', position: [-60.72, 1.42, 35.55], yaw: Math.PI / 2, width: 1.85, height: 0.16, thickness: 0.52, material: 'agedWood', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'maintenance-shelf', 'wall-mounted'] },
    { id: 'folsom_shrine_keeper_wall_shelf_high', kind: 'stela', position: [-60.72, 2.18, 35.55], yaw: Math.PI / 2, width: 1.45, height: 0.14, thickness: 0.46, material: 'agedWood', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'maintenance-shelf', 'wall-mounted', 'broken'] },
    { id: 'folsom_shrine_keeper_floor_slab', kind: 'altar', position: [-58.8, 0.788, 39.15], width: 1.75, depth: 1.05, height: 0.22, material: 'shrineStone', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'low-maintenance-slab', 'non-blocking-dressing'] },
    ...[-54.2, -58.9].flatMap((x, index) => [
      { id: `folsom_shrine_keeper_frame_${index}_north_post`, kind: 'stela', position: [x, 0.788, 43.68], width: 0.24, height: 2.62, thickness: 0.24, material: 'agedWood', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'old-maintenance-framing'] },
      { id: `folsom_shrine_keeper_frame_${index}_south_post`, kind: 'stela', position: [x, 0.788, 34.32], width: 0.24, height: 2.62, thickness: 0.24, material: 'agedWood', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'old-maintenance-framing'] },
    ]),
    { id: 'folsom_shrine_keeper_frame_north_header', kind: 'lowWall', from: [-60.45, 43.7], to: [-52.4, 43.7], y: 3.08, height: 0.24, thickness: 0.26, material: 'agedWood', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'old-maintenance-framing', 'roof-pressure'] },
    { id: 'folsom_shrine_keeper_floor_grate', kind: 'altar', position: [-55.45, 0.79, 40.55], width: 1.35, depth: 1.7, height: 0.08, material: 'rustedIron', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'maintenance-floor-grate', 'cord-entry'] },
    { id: 'folsom_shrine_crawlspace_panel', kind: 'stela', position: [-61.08, 0.788, 39], yaw: Math.PI / 2, width: 2.42, height: 1.4, thickness: 0.22, material: 'darkStone', blocksPlayer: true, roomId: 'folsom_bounds', tags: ['shrine-side-room', 'crawlspace-panel', 'lantern-readable-edge'] },
    ...[-62.2, -64.35, -66.5].flatMap((x, index) => [
      { id: `folsom_shrine_crawlspace_frame_${index}_north`, kind: 'stela', position: [x, 0.79, 40.28], width: 0.24, height: 1.48, thickness: 0.28, material: 'agedWood', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-crawlspace', 'maintenance-frame', 'root-pressure'] },
      { id: `folsom_shrine_crawlspace_frame_${index}_south`, kind: 'stela', position: [x, 0.79, 37.72], width: 0.24, height: 1.48, thickness: 0.28, material: 'agedWood', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-crawlspace', 'maintenance-frame', 'root-pressure'] },
      { id: `folsom_shrine_crawlspace_frame_${index}_header`, kind: 'lowWall', from: [x, 37.72], to: [x, 40.28], y: 2.13, height: 0.2, thickness: 0.3, material: 'agedWood', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-crawlspace', 'low-maintenance-frame', 'root-pressure'] },
    ]),
    { id: 'folsom_shrine_crawlspace_buried_slab_left', kind: 'altar', position: [-64.1, 0.79, 38.05], width: 2.6, depth: 0.7, height: 0.18, material: 'darkStone', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-crawlspace', 'buried-slab', 'non-blocking-dressing'] },
    { id: 'folsom_shrine_crawlspace_buried_slab_right', kind: 'altar', position: [-66.35, 0.79, 40.02], width: 2.15, depth: 0.62, height: 0.14, material: 'shrineStone', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-crawlspace', 'buried-slab', 'non-blocking-dressing'] },
    { id: 'folsom_shrine_crawlspace_terminal_slab', kind: 'stela', position: [-68.72, 0.788, 39], yaw: Math.PI / 2, width: 2.7, height: 1.45, thickness: 0.32, material: 'rustedIron', blocksPlayer: true, roomId: 'folsom_bounds', tags: ['shrine-crawlspace', 'blocked-maintenance-throat', 'no-route-bypass'] },
    { id: 'folsom_shrine_crawlspace_terminal_stone_collar', kind: 'doorFrame', position: [-68.62, 0.788, 39], yaw: Math.PI / 2, width: 3.02, height: 1.72, thickness: 0.34, depth: 0.48, material: 'darkStone', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-crawlspace', 'terminal-throat-collar', 'no-route-bypass'] },
    ...[-0.95, -0.48, 0, 0.48, 0.95].map((zOffset, index) => ({
      id: `folsom_shrine_crawlspace_terminal_bar_${index}`,
      kind: 'stela', position: [-68.48, 0.788, 39 + zOffset], yaw: Math.PI / 2, width: 0.1, height: 1.35, thickness: 0.1,
      material: 'rustedIron', blocksPlayer: false, roomId: 'folsom_bounds', tags: ['shrine-crawlspace', 'maintenance-grate', 'buried-cords-beyond'],
    })),
  ...
  outdoorChests: [
    ...
    { id: 'folsom_courtyard_mace_chest', bodyMaterial: 'agedWood', strapMaterial: 'rustedIron', label: 'Courtyard Mace Chest', position: { x: 3, y: 0.188, z: -1.5 }, itemId: 'dreadstone_mace', acquiredMessage: 'Dreadmace Acquired.', tags: ['courtyard', 'combat-showcase', 'immediate-use'] },
  ...
  outdoorInteractions: [
    ...
    { id: 'folsom_shrine_side_room_seal', label: 'Growth-bound side door', target: { x: -51.72, y: 1.62, z: 38.32 }, range: 3.1, hint: 'Growth-bound side door', message: 'Black cord grips an old maintenance latch.', type: 'folsomShrineSideRoomSeal' },
    { id: 'folsom_shrine_crawlspace_panel_open', label: 'Low maintenance panel', target: { x: -60.55, y: 1.35, z: 39 }, range: 2.8, hint: 'Low maintenance panel', message: 'The panel edge disappears beneath old scab.', type: 'folsomShrineCrawlspacePanel' },
  ...
  structurePads: [
    ...
    { id: 'shrine-side-room', center: [-56.5, 39], stampId: 'folsom_shrine_side_room_pad', floorId: 'folsom_shrine_side_room_floor' },
    { id: 'shrine-crawlspace', center: [-65, 39], stampId: 'folsom_shrine_crawlspace_pad', floorId: 'folsom_shrine_crawlspace_floor' },
  ...
  validationRoutes: [
    ...
    { id: 'shrine-side-room', points: [[-42, 31], [-49, 36], [-53.5, 38.3], [-57, 38.5], [-60, 39]] },
