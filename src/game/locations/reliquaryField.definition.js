...
export const reliquaryFieldDefinition = Object.freeze({
  ...
  spawns: [
    ...
    { id: 'field_oarb_feature_yard_return', kind: 'return', position: { x: 84, y: 1.55, z: 137 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['temporary', 'oarb-feature-yard'] },
  ...
  exits: [
    ...
    },
    {
      ...
      triggerRect: { minX: 80, maxX: 88, minZ: 122, maxZ: 130 },
      position: { x: 84, y: 1, z: 126 },
      ...
      userData: {
        ...
        placementNote: 'Placed in Reliquary Field near the Kerovac exterior approach but offset east and south of the Kerovac temporary gate so return spawns cannot overlap either transition.',
      },
    },
    {
