...
export const reliquaryFieldDefinition = Object.freeze({
  ...
  textures: {
    ...
    fieldGrass: { ...outdoorTextureProfiles.grassDryStraw, repeat: [50, 50] },
    forestGround: { ...outdoorTextureProfiles.grassPatchyDirt, repeat: [50, 50], color: 0xb0aa91, emissive: 0x20232a, emissiveIntensity: 0.08 },
    mudTrail: { ...outdoorTextureProfiles.mudCrackedDry, repeat: [18, 3], color: 0x5f4b37, emissive: 0x140e09, emissiveIntensity: 0.04, worldTileLength: 8, worldTileWidth: 3 },
    rockWall: { path: './assets/textures/wall_black_stone_01.png', repeat: [2.5, 1.5], color: 0x514d49, roughness: 0.98, metalness: 0.0, emissive: 0x12100f, emissiveIntensity: 0.08 },
    stoneOutcrop: { path: './assets/textures/wall_black_stone_01.png', repeat: [1.4, 1.2], color: 0x68645c, roughness: 0.99, metalness: 0.0, emissive: 0x141210, emissiveIntensity: 0.06 },
    darkRoot: { path: './assets/textures/outdoor/field_dead_grass_01.png', repeat: [2.0, 1.0], color: 0x2a160f, roughness: 1.0, metalness: 0.0, emissive: 0x090403, emissiveIntensity: 0.05 },
  ...
  blockers: [
    ...
    exteriorBlocker('KEROVAC_EXT_LEFT_PIER', 56.4, 57.6, 143.5, 148.5, { height: 5.2, visualStructureId: 'KEROVAC_EXT_LEFT_PIER-limestone-sun-gate' }),
  ...
  spawns: [
    { id: 'field_player_start', kind: 'player', position: { x: 0, y: 1.55, z: -175 }, yaw: 0, roomId: 'FIELD01', tags: ['live'], userData: { runtimeSpawnKey: 'start' } },
    { id: 'field_south_reliquary_crypt_return', kind: 'return', position: { x: -60, y: 1.55, z: -112 }, yaw: 0, roomId: 'FIELD01', tags: ['live', 'south-reliquary-crypt'], userData: { runtimeSpawnKey: 'cryptAExit', returnFromLocation: 'south-reliquary-crypt' } },
    { id: 'field_black_grass_temple_return', kind: 'return', position: { x: -184, y: 1.55, z: 25 }, yaw: 0, roomId: 'FIELD01', tags: ['live', 'black-grass-temple'], userData: { runtimeSpawnKey: 'blackGrassTempleExit', returnFromLocation: 'black-grass-temple' } },
    { id: 'field_keeper_house_return', kind: 'return', position: { x: 142, y: 1.55, z: -82 }, yaw: 0, roomId: 'FIELD01', tags: ['live', 'field-keeper-house'], userData: { runtimeSpawnKey: 'fieldKeeperHouseExit', returnFromLocation: 'field-keeper-house' } },
    { id: 'field_ddplus_level_1_return', kind: 'return', position: { x: 154, y: 1.55, z: 104 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['temporary', 'ddplus-test', 'level-1'], userData: { runtimeSpawnKey: 'ddplusLevel1Exit', returnFromLocation: 'level-1' } },
    { id: 'field_sumerian_city_block_v0_return', kind: 'return', position: { x: 122, y: 1.55, z: 144.5 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['temporary', 'sumerian-city-block-v0'], userData: { runtimeSpawnKey: 'sumerianCityBlockV0Exit', returnFromLocation: 'sumerian-city-block-v0' } },
    { id: 'field_sumerian_sun_palace_district_v1_return', kind: 'return', position: { x: 96, y: 1.55, z: 144.5 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['temporary', 'sumerian-sun-palace-district-v1'], userData: { runtimeSpawnKey: 'sumerianSunPalaceDistrictV1Exit', returnFromLocation: 'sumerian-sun-palace-district-v1' } },
    { id: 'field_sumerian_canal_market_district_v2_return', kind: 'return', position: { x: 110, y: 1.55, z: 118 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['temporary', 'sumerian-canal-market-district-v2'], userData: { runtimeSpawnKey: 'sumerianCanalMarketDistrictV2Exit', returnFromLocation: 'sumerian-canal-market-district-v2' } },
    { id: 'field_balthazan_return', kind: 'return', position: { x: 72, y: 1.55, z: 116 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['temporary', 'balthazan', 'sumerian-canal-city'], userData: { runtimeSpawnKey: 'balthazanExit', returnFromLocation: 'balthazan' } },
    { id: 'field_kerovac_return', kind: 'return', position: { x: 60, y: 1.55, z: 134 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['temporary', 'kerovac', 'bright-interior-city', 'sacred-sun-city'], userData: { runtimeSpawnKey: 'kerovacExit', returnFromLocation: 'kerovac' } },
    { id: 'field_oarb_feature_yard_return', kind: 'return', position: { x: 83, y: 1.55, z: 155 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['temporary', 'oarb-feature-yard'], userData: { runtimeSpawnKey: 'oarbFeatureYardExit', returnFromLocation: 'oarbFeatureYard' } },
    { id: 'field_oarb_outdoor_expo_return', kind: 'return', position: { x: 88, y: 1.55, z: 176 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['temporary', 'oarb-outdoor-expo'], userData: { runtimeSpawnKey: 'oarbOutdoorExpoExit', returnFromLocation: 'oarbOutdoorExpo' } },
    { id: 'field_v2_test_shrine_return', kind: 'return', position: { x: 68, y: 1.55, z: 134 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['temporary', 'v2-test-shrine'], userData: { runtimeSpawnKey: 'v2TestShrineExit', returnFromLocation: 'v2-test-shrine' } },
    { id: 'field_folsom_return', kind: 'return', position: { x: 0, y: 1.55, z: -176 }, yaw: Math.PI, roomId: 'FIELD01', tags: ['folsom', 'legacy-door-return'], userData: { runtimeSpawnKey: 'folsomExit', returnFromLocation: 'folsom' } },
  ],
  exits: [
    {
    ...
    {
      id: 'field_enter_balthazan',
      fromLocation: 'reliquary-field',
      toLocation: 'balthazan',
      triggerRect: { minX: 68, maxX: 76, minZ: 122, maxZ: 130 },
      position: { x: 72, y: 1, z: 126 },
      destinationSpawnId: 'balthazan_player_start',
      promptText: 'Enter Balthazan',
      tags: ['temporary', 'balthazan', 'sumerian-canal-city'],
      userData: {
        temporary: true,
    ...
    },
    {
      ...
      triggerRect: { minX: 68, maxX: 72, minZ: 160, maxZ: 168 },
      position: { x: 70, y: 1, z: 164 },
      destinationSpawnId: 'oarb_feature_yard_player_start',
      promptText: 'Tap INTERACT to enter the OARB Proving Grounds.',
      tags: ['temporary', 'oarb-feature-yard', 'kerovac-approach'],
      userData: {
        temporary: true,
        foliageClearRadius: 24,
        visibleMarker: { type: 'standing-stone-arch', ids: ['OARB_PROVING_GROUNDS_LEFT_STONE', 'OARB_PROVING_GROUNDS_RIGHT_STONE', 'OARB_PROVING_GROUNDS_LINTEL', 'OARB_PROVING_GROUNDS_PATH'] },
    ...
    },
    {
      ...
      userData: {
        ...
        returnSpawnId: 'field_kerovac_return',
        returnSpawnSafetyMargin: 6,
        requestedNearbyPlacement: { x: 54, y: 1, z: 146 },
        placementNote: 'Placed just east of the requested point because x 54, z 146 overlaps the existing sunken tomb side block; this keeps the Kerovac gate visible and non-overlapping.',
      },
    },
    {
