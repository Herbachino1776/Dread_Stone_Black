...
const textures = Object.freeze({
  ...
  pondWater: { color: 0x123f46, roughness: 0.82, metalness: 0.0, transparent: true, opacity: 0.72, emissive: 0x03171b, emissiveIntensity: 0.16 },
...
export const oarbFeatureYardDefinition = Object.freeze({
  ...
  terrain: {
    ...
    heightStamps: [
      ...
      { id: 'oarb_yard_training_pond_shore_shelf', kind: 'flatten', center: [60, 34], radius: 27, y: -0.28 },
      { id: 'oarb_yard_training_pond_bowl', kind: 'hollow', center: [60, 34], radius: 23, depth: 0.82 },
      { id: 'oarb_yard_training_pond_floor_flatten', kind: 'flatten', center: [60, 34], radius: 18, y: -0.78 },
      { id: 'oarb_yard_training_pond_chest_pad', kind: 'flatten', center: [42, 52], radius: 7, y: -0.12 },
  ...
  splineTrails: [
    ...
    { id: 'oarb_yard_pond_approach_trail', points: [[0, -74], [18, -48], [34, -18], [50, 6], [56, 24], [44, 48]], width: 4.4, material: 'mudTrail', flatten: true, tags: ['terrain-following', 'pond-cue'] },
  ],
  waterBodies: [
  ...
  outdoorPrimitives: [
    ...
    { id: 'oarb_yard_pond_stones_visible', kind: 'boulderCluster', center: [42, 36], radius: 3.2, material: 'stoneOutcrop', tags: ['pond-cue', 'shoreline'] },
  ],
  curvedBlockers: [
