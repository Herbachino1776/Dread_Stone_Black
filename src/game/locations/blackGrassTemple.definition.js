...
export const blackGrassTempleDefinition = Object.freeze({
  ...
  integrity: {
    ...
    structuralPropKinds: ['gate', 'pillar', 'altar', 'counter', 'divider', 'reliquary'],
    nonBlockingDecor: [
  ...
  rooms: [
    ...
    room({ id: 'D06C', label: 'Main Descent Connector', minX: -2.3, maxX: 2.3, minZ: -23, maxZ: -13, repeat: [1, 2], tags: ['connector'], safeForSpawn: false, wallGeometry: false, userData: { role: 'declared R03 to R06 main-route throat' } }),
    room({ id: 'D07C', label: 'West Storage Loop Connector', minX: -36, maxX: -32, minZ: -9, maxZ: -8, repeat: [1, 1], tags: ['connector'], safeForSpawn: false, wallGeometry: false }),
    room({ id: 'D09C', label: 'Service/Tavern Connector', minX: -26, maxX: -25, minZ: 2, maxZ: 6, repeat: [1, 1], tags: ['connector'], safeForSpawn: false, wallGeometry: false }),
    room({ id: 'D12C', label: 'West Drinking Hall Connector', minX: -32, maxX: -31, minZ: 39, maxZ: 43, repeat: [1, 1], tags: ['connector'], safeForSpawn: false, wallGeometry: false }),
    room({ id: 'D13C', label: 'East Drinking Hall Connector', minX: 31, maxX: 32, minZ: 39, maxZ: 43, repeat: [1, 1], tags: ['connector'], safeForSpawn: false, wallGeometry: false }),
  ...
  doors: [
    ...
    connector('D06', 'R03', 'R06', 0, -18, 4.6, [wallGap('R03', 0, -23, 4.6), wallGap('D06C', 0, -23, 4.6), wallGap('D06C', 0, -13, 4.6), wallGap('R06', 0, -13, 4.6)]),
    connector('D07', 'R04', 'R07', -34, -8.5, 3.6, [wallGap('R04', -34, -9, 3.6), wallGap('D07C', -34, -9, 3.6), wallGap('D07C', -34, -8, 3.6), wallGap('R07', -34, -8, 3.6)]),
    connector('D08', 'R05', 'R06', 24.2, -11, 4.0, [wallGap('R05', 24, -11, 4), wallGap('R06', 25, -11, 4)]),
    connector('D09', 'R07', 'R06', -25.5, 4, 3.6, [wallGap('R07', -26, 4, 3.6), wallGap('D09C', -26, 4, 3.6), wallGap('D09C', -25, 4, 3.6), wallGap('R06', -25, 4, 3.6)]),
    ...
    connector('D12', 'R08', 'R09', -31.5, 41, 4.0, [wallGap('R08', -31, 41, 4), wallGap('D12C', -31, 41, 4), wallGap('D12C', -32, 41, 4), wallGap('R09', -32, 41, 4)]),
    connector('D13', 'R08', 'R10', 31.5, 41, 4.0, [wallGap('R08', 31, 41, 4), wallGap('D13C', 31, 41, 4), wallGap('D13C', 32, 41, 4), wallGap('R10', 32, 41, 4)]),
  ...
  blockers: [
    ...
    blocker('BGT_CENTRAL_RELIQUARY_BLOCK', 'altar', -3, 3, 82, 84, 1.6),
    blocker('BGT_SEALED_NORTH_GATE', 'gate', -4, 4, 93.78, 94.22, 3.2),
    blocker('BGT_RUSTED_GATE_WATCH_GATE', 'gate', 29.775, 30.225, -24, -16, 3.2),
  ],
  ...
  props: [
    ...
    prop('BGT-P14-central-reliquary-block', 'reliquary', 'R12', 0, 0.8, 83, 6, 1.6, 2, 'BGT_CENTRAL_RELIQUARY_BLOCK'),
    prop('BGT-P15-sealed-future-gate', 'gate', 'R13', 0, 1.6, 94, 8, 3.2, 0.45, 'BGT_SEALED_NORTH_GATE', 'gate'),
    prop('BGT-G01-first-gate-inspect-rusted-metal', 'gate', 'R05', 30, 1.6, -20, 0.45, 3.2, 8, 'BGT_RUSTED_GATE_WATCH_GATE', 'gate'),
  ...
  torchFixtures: [
    torchFixture('BGT-T01', 'R01', 'north', 2.0, 'dungeonTorch', { note: 'Entry guidance toward D02, mounted off the R01 north doorway center.' }),
    torchFixture('BGT-T02', 'R02', 'west', 4.0, 'dungeonTorch', { note: 'Vestibule orientation torch.' }),
    torchFixture('BGT-T03', 'R02', 'east', 4.0, 'dungeonTorch', { note: 'Vestibule orientation torch.' }),
    torchFixture('BGT-T04', 'R03', 'north', 6.0, 'dungeonTorch', { note: 'Offering slab and rusted sword chest focus from the north wall.' }),
  ...
  interactions: [
    ...
    {
      id: 'BGT_INT_OFFERING_CHEST',
      target: { x: -12.6, y: 1.0, z: -36.2 },
      range: 3.1,
      hint: 'Inspect chest',
      message: 'The offering chest is empty.',
  ...
  navigation: {
    roomGraph: {
      ...
      links: [
        ...
        { id: 'D06_NAV', fromRoom: 'R03', toRoom: 'R06', navWaypoint: { x: 0, y: 0, z: -18 } },
        { id: 'D07_NAV', fromRoom: 'R04', toRoom: 'R07', navWaypoint: { x: -34, y: 0, z: -8.5 } },
        { id: 'D08_NAV', fromRoom: 'R05', toRoom: 'R06', navWaypoint: { x: 24.2, y: 0, z: -11 } },
        ...
        { id: 'D12_NAV', fromRoom: 'R08', toRoom: 'R09', navWaypoint: { x: -31.5, y: 0, z: 41 } },
        { id: 'D13_NAV', fromRoom: 'R08', toRoom: 'R10', navWaypoint: { x: 31.5, y: 0, z: 41 } },
