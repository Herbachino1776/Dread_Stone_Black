...
props.push(
  ...
  { id: 'under_shrine_labyrinth_end_hatch_pry_socket', roomId: 'USL10', position: { x: 64.38, y: -1.48, z: 8.72 }, rotation: { x: 0, y: Math.PI / 2, z: -0.12 }, dimensions: { width: 0.64, height: 0.48, depth: 0.34 }, material: 'iron', tags: ['pry-socket', 'buried-hatch-fulcrum', 'visible-tool-contact'] },
...
export const underShrineLabyrinthDefinition = Object.freeze({
  ...
  physicalToolTargets: Object.freeze([
    { id: 'under_shrine_labyrinth_end_hatch', acceptedToolId: 'iron_drain_bar', acceptedActionType: 'pry', socket: { geometryIds: ['under_shrine_labyrinth_end_hatch_pry_socket'], position: [64.18, -1.35, 8.72], volume: { radius: 0.42 }, seatingRadiusPx: 62 }, lever: { directionScreen: [0.12, -1], arcPx: 126 }, tensionThreshold: 1, stageOrder: ['buried', 'strained', 'open'], completionSaveKey: 'under_shrine_labyrinth_end_hatch_open', blockerId: 'under_shrine_labyrinth_end_hatch_blocker', visualStrainStages: [0, 0.4, 0.8, 1], failFeedback: 'metal-stone-skid' },
  ]),
