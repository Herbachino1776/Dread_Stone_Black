...
const props = [
  ...
  prop('beneath_folsom_drain_grate_pry_socket_back', 'BF02', { x: -2.1, y: 0.82, z: 13.24 }, { width: 0.72, height: 0.5, depth: 0.2 }, 'rustedIron', { rotation: { x: 0, y: 0, z: -0.18 }, tags: ['pry-socket', 'bent-rusted-fulcrum', 'visible-tool-contact'] }),
  prop('beneath_folsom_drain_grate_pry_socket_lip', 'BF02', { x: -2.1, y: 0.62, z: 13.04 }, { width: 0.78, height: 0.12, depth: 0.48 }, 'rustedIron', { rotation: { x: 0, y: 0, z: -0.18 }, tags: ['pry-socket', 'forgiving-notch', 'visible-tool-contact'] }),
  ...
  prop('beneath_folsom_lower_shrine_hatch_pry_socket', 'BF04', { x: -2.18, y: 0.82, z: 61.08 }, { width: 0.82, height: 0.56, depth: 0.32 }, 'rustedIron', { rotation: { x: 0, y: 0, z: -0.14 }, tags: ['pry-socket', 'stone-iron-notch', 'heavy-fulcrum', 'visible-tool-contact', 'moving-hatch-part'] }),
  prop('beneath_folsom_lower_shrine_hatch_socket_stone', 'BF04', { x: -2.18, y: 0.55, z: 61.2 }, { width: 1.22, height: 0.24, depth: 0.52 }, 'coldThresholdStone', { tags: ['pry-socket', 'worn-stone-seat', 'visible-tool-contact', 'moving-hatch-part'] }),
...
export const beneathFolsomDefinition = Object.freeze({
  ...
  physicalToolTargets: Object.freeze([
    { id: 'beneath_folsom_drain_grate', acceptedToolId: 'iron_drain_bar', acceptedActionType: 'pry', socket: { geometryIds: ['beneath_folsom_drain_grate_pry_socket_back', 'beneath_folsom_drain_grate_pry_socket_lip'], position: [-2.1, 0.72, 13.02], volume: { radius: 0.52 }, seatingRadiusPx: 82 }, lever: { directionScreen: [0.18, -1], arcPx: 86 }, tensionThreshold: 1, stageOrder: ['jammed', 'strained', 'pried'], completionSaveKey: 'beneath_folsom_drain_grate_pried', blockerId: 'beneath_folsom_drain_grate_blocker', visualStrainStages: [0, 0.45, 0.8, 1], failFeedback: 'metal-skid' },
    ...
    { id: 'beneath_folsom_lower_shrine_hatch', acceptedToolId: 'iron_drain_bar', acceptedActionType: 'pry', socket: { geometryIds: ['beneath_folsom_lower_shrine_hatch_pry_socket', 'beneath_folsom_lower_shrine_hatch_socket_stone'], position: [-2.18, 0.78, 60.98], volume: { radius: 0.38 }, seatingRadiusPx: 64 }, lever: { directionScreen: [0.08, -1], arcPx: 142 }, tensionThreshold: 1, stageOrder: ['stone-bound', 'strained', 'open'], prerequisites: ['beneath_folsom_hidden_growth_gate_cleared'], completionSaveKey: 'beneath_folsom_lower_shrine_hatch_open', blockerId: 'beneath_folsom_lower_shrine_hatch_blocker', visualStrainStages: [0, 0.32, 0.8, 1], failFeedback: 'stone-skid' },
